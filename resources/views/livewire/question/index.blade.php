        ...
        <div class="card-header">
          ...
          <!-- Import Excel -->
            <div class="modal fade" id="importExcel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <form method="post" action="{{route('livewire.question.import')}}" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-1">
                    <select wire:model="orderBy" class="form-control bg-light float-right">
                        ...
                        <option value="kelas_id">CKelas</option>
                        <option value="topic_id">Topik</option>
                        <option value="competency_id">Kompetensi</option>
                        <option value="sub_competency_id">Sub Kompetensi</option>
                        <option value="title">Soal</option>
                    </select>
                </div>
                <div class="col-md-1">
            ...
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">{{ $item->topic->title }}</td>
                        <td class="text-center">{{ $item->competency->title }}</td>
                        <td class="text-center">{{ $item->subCompetency->title }}</td>
                        <td class="text-center">{{ $item->question_text }}</td>
