...
<div class="content-wrapper">
    ...
    <div class="card">
        <div class="card-header">
            ...
            @if($isModalOpen)
            @include('livewire.competency.create')
            @endif
          ...
          <!-- Import Excel -->
            <div class="modal fade" id="importExcel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <form method="post" action="{{route('livewire.competency.import')}}" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-1">
                    <select wire:model="orderBy" class="form-control bg-light float-right">
                        ...
                        <option value="title">Kompetensi</option>
                    </select>
                </div>
                <div class="col-md-1">
