          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Sub Kompetensi</li>
              </ol>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="card-header">
          ...
          <!-- Import Excel -->
            <div class="modal fade" id="importExcel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <form method="post" action="{{route('livewire.sub-competency.import')}}" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-1">
                    <select wire:model="orderBy" class="form-control bg-light float-right">
                        ...
                        <option value="title">Sub Kompetensi</option>
                    </select>
                </div>
                <div class="col-md-1">
